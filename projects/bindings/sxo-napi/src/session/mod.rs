...
impl Session {
    ...
    ///
    /// Prefer [`Self::differentiate_wolfram_form`] / [`Self::differentiate_matlab_form`] for
    /// retained dialect Forms. This path remains for result objects that only hold a projected term.
    ...
    ///
    /// Prefer [`Self::simplify_wolfram_form`] / [`Self::simplify_matlab_form`] for retained Forms.
