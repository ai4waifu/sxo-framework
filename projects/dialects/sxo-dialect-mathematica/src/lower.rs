...
pub fn surface_to_semantic(name: &str) -> Option<SemanticOperator> {
    Some(match name {
        ...
        "Mod" => SemanticOperator::Mod,
        "Quotient" => SemanticOperator::Quotient,
        "IntegerDigits" => SemanticOperator::IntegerDigits,
        ...
        "Timing" => SemanticOperator::Timing,
        "Trace" => SemanticOperator::Trace,
        ...
        "MemberQ" => SemanticOperator::MemberQ,
        "Sort" => SemanticOperator::Sort,
        "DeleteDuplicates" => SemanticOperator::DeleteDuplicates,
        "Count" => SemanticOperator::Count,
        "Partition" => SemanticOperator::Partition,
        "ConstantArray" => SemanticOperator::ConstantArray,
        "Union" => SemanticOperator::Union,
        "Intersection" => SemanticOperator::Intersection,
...
pub fn semantic_to_surface(op: SemanticOperator) -> &'static str {
    match op {
        ...
        SemanticOperator::Timing => "Timing",
        SemanticOperator::Trace => "Trace",
