...
pub fn surface_to_semantic(name: &str) -> Option<SemanticOperator> {
    Some(match name {
        ...
        "max" | "Max" => SemanticOperator::Max,
        "min" | "Min" => SemanticOperator::Min,
...
pub fn semantic_to_surface(op: SemanticOperator) -> &'static str {
    match op {
        ...
        SemanticOperator::ElementwiseAnd => "ElementwiseAnd",
        SemanticOperator::ElementwiseOr => "ElementwiseOr",
        SemanticOperator::Determinant => "Det",
        SemanticOperator::Sum => "Sum",
        SemanticOperator::Product => "Product",
