...
export const featureMatrix = [
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: '1:3 becomes Span(1, 3), not expanded range; SILENT WRONG: 1:2:10 → Span(Span(1, 2), 10) nested Span',
        cases: [
            {
                id: 'colon.range',
                kind: 'gap',
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'stateful',
        notes: 'Own Set persists on host Session; indexed/grow assignment still broken',
        cases: [
            {
                id: 'assign.compound',
                kind: 'eval',
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: 'try/catch may accidentally return catch body; error semantics unclear',
        cases: [
            {
                id: 'try.catch',
                kind: 'gap',
    ...
    },
    {
        ...
        cases: [
            ...
            },
            {
                ...
                input: '[1, 2; 3, 4](:,2)',
                expected: '[2, 4]',
                notes: 'column as List of picks; semicolon column shape pending',
            },
        ],
    },
    {
