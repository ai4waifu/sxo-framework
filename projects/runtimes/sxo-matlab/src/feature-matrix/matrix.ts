...
export const featureMatrix = [
    ...
    },
    {
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'SILENT WRONG: .* lowers to *; elementwise not distinguished',
        cases: [
            { id: 'times.scalar', kind: 'gap', input: '2 .* [1, 2]', expected: '[2, 4]',
                notes: 'currently 2*[1, 2]',
            },
            {
                id: 'times.vec',
                kind: 'gap',
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: 'scalar ^ OK; .^ vector broken / .^0→1 SILENT WRONG',
        cases: [
    ...
    },
    {
        ...
        cases: [
            ...
            { id: 'rdivide.vec', kind: 'gap', input: '[6, 8]./[2, 4]', expected: '[3, 2]',
                notes: 'currently [2, 4]^-1*[6, 8]',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'SILENT WRONG: 1:2:10 → Span(Span(1,2),10) not numeric vector',
        cases: [
            {
                id: 'colon.range',
                kind: 'gap',
                input: '1:3',
                expected: '[1, 2, 3]',
                notes: 'Span(1,3) expands under Range/iterator; bare Span display pending',
            },
            {
                id: 'colon.step',
                kind: 'gap',
                input: '1:2:10',
                expected: '[1, 3, 5, 7, 9]',
                notes: 'currently Span(Span(1, 2), 10)',
            },
        ],
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: '1-based Part indexing; row/col All via colon; growth assignment pending',
        cases: [
    ...
    },
    {
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'oak error on [1,2,3](end)',
        cases: [{ id: 'end.index', kind: 'gap', input: '[1, 2, 3](end)', expected: '3',
                notes: 'currently Error: matlab(oak): error node',
            }],
    },
    {
        name: 'transpose',
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'stateful',
        notes: 'x=5 returns 5; compound x=5;x+1 → 1+x (no Session bind)',
        cases: [
            {
                id: 'assign.compound',
                kind: 'gap',
    ...
    },
    {
        ...
        cases: [
            { id: 'ne.true', kind: 'eval', input: '3 ~= 2', expected: '1' },
            { id: 'ne.false', kind: 'eval', input: '1 ~= 1', expected: '0' },
            {
                id: 'ne.vec',
                kind: 'gap',
                input: '[1, 2] ~= [1, 3]',
    ...
    },
    {
        ...
        cases: [
            { id: 'le.true', kind: 'eval', input: '2 <= 3', expected: '1' },
            {
                id: 'le.vec',
                kind: 'gap',
                input: '[1, 2] <= [1, 3]',
    ...
    },
    {
        ...
        cases: [
            { id: 'ge.true', kind: 'eval', input: '1 >= 1', expected: '1' },
            { id: 'ge.false', kind: 'eval', input: '1 >= 2', expected: '0' },
            {
                id: 'ge.vec',
                kind: 'gap',
                input: '[1, 2, 3] >= 2',
        ...
        cases: [
            {
                ...
                input: '[1,2;3,4] \\ [5;6]',
                expected: '[-4; 9/2]',
                notes: 'currently [1, 2; 3, 4]^-1*[5; 6]; exact rational column; not A^-1*b text',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'unevaluated echo; MatrixValue bridge not wired for eye(n)',
        cases: [{ id: 'eye.2', kind: 'gap', input: 'eye(2)', expected: '[1, 0; 0, 1]',
                notes: 'currently eye(2)',
            }],
    },
    {
        name: 'zeros',
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'unevaluated echo; MatrixValue bridge not wired for zeros(m,n)',
        cases: [{ id: 'zeros.23', kind: 'gap', input: 'zeros(2, 3)', expected: '[0, 0, 0; 0, 0, 0]',
                notes: 'currently zeros(2, 3)',
            }],
    },
    {
        name: 'ones',
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'ones(n)/ones(m,n) via MatrixValue bridge',
        cases: [{ id: 'ones.2', kind: 'gap', input: 'ones(2)', expected: '[1, 1; 1, 1]',
                notes: 'currently ones(2)',
            }],
    },
    {
        name: 'size',
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'size(A) → [rows, cols]; flat list treated as 1×n row',
        cases: [{ id: 'size.2x2', kind: 'gap', input: 'size([1, 2; 3, 4])', expected: '[2, 2]',
                notes: 'currently size([1, 2; 3, 4])',
            }],
    },
    {
        name: 'length',
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'length maps to Athena Length',
    ...
    },
    {
        ...
        cases: [
            { id: 'sum.vec', kind: 'gap', input: 'sum([1, 2, 3])', expected: '6',
                notes: 'currently sum([1, 2, 3])',
            },
            { id: 'sum.matrix', kind: 'gap', input: 'sum([1, 2; 3, 4])', expected: '[4, 6]',
                notes: 'currently sum([1, 2; 3, 4])',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: 'error→catch body OK; SILENT WRONG: success path still returns catch body',
        cases: [
            {
                id: 'try.catch',
                kind: 'eval',
            ...
            },
            {
                ...
                expected: '2',
                notes: 'SILENT WRONG: currently returns catch body 3',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        status: 'unsupported',
        effect: 'pure',
        notes: 'All-colon row/col Part works on literals; column renders as flat list not [2;4]',
        cases: [
            {
                id: 'row.colon',
                kind: 'gap',
            ...
            },
            {
                ...
                input: '[1, 2; 3, 4](:,2)',
                expected: '[2, 4]',
                notes: 'currently Error: matlab(oak): error node; column as List of picks; semicolon column shape pending',
            },
        ],
    },
    {
    ...
    // --- wave 6: logic ops / assignment / strings / symbolic / interop ---
    {
        ...
        cases: [{ id: 'and.10', kind: 'eval', input: '1 && 0', expected: '0' }],
    },
    {
        name: 'or',
        category: 'logic',
        status: 'supported',
        effect: 'pure',
        cases: [{ id: 'or.10', kind: 'eval', input: '1 || 0', expected: '1' }],
    },
    {
        name: 'not',
        category: 'logic',
        ...
        effect: 'pure',
        cases: [
            { id: 'not.1', kind: 'eval', input: '~1', expected: '0' },
            { id: 'not.0', kind: 'eval', input: '~0', expected: '1' },
        ],
    },
    {
        name: 'xor',
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: '1<2<3 → 1; vectorized [1,2,3]<2 stays Less head',
        cases: [
            { id: 'ltchain.123', kind: 'eval', input: '1 < 2 < 3', expected: '1' },
            {
                id: 'ltchain.vec',
                kind: 'gap',
                input: '[1, 2, 3] < 2',
