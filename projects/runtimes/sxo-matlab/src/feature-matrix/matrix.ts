...
export const featureMatrix = [
    ...
    },
    {
        ...
        status: 'partial',
        effect: 'pure',
        notes: '1:2:10 expands via Span; bare 1:3 still Span until Range demand',
        cases: [
            {
                id: 'colon.range',
                kind: 'gap',
    ...
    },
    {
        ...
        status: 'supported',
        effect: 'pure',
        notes: 'end resolves against list/matrix extent in Part',
    ...
    },
    {
        ...
        status: 'supported',
        effect: 'pure',
        notes: 'eye(n)/eye(m,n) via MatrixValue bridge → nested List',
    ...
    },
    {
        ...
        status: 'supported',
        effect: 'pure',
        notes: 'zeros(n)/zeros(m,n) via MatrixValue bridge',
